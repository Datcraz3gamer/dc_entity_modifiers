execute as @e[type=!#nomodify,limit=1,sort=nearest,distance=..1] run team join tagDkRed
execute as @e[type=!#nomodify,limit=1,sort=nearest,distance=..1] run data merge entity @s {PersistenceRequired:1b}
execute store success score @s em_Success run execute as @e[type=!#nomodify,limit=1,sort=nearest,distance=..1] run team join tagDkRed
